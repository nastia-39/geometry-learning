...
\title{Learning a function energy space} 
\date{December 2025}
...
Assume, the regularizer depends on some parameter $\theta$. Then learning it equivalent to minimizing the negative log-likelihood:
\begin{align*}
...
\section{Manifold Hypothesis and its Shortcomings}
...
Let's formulate the extension of the manifold hypothesis to this case.
