...
\begin{itemize}
    \item If we know \emph{the right} kernel $\kappa(x, y)$, given $\{(\vx_i, y_i)\}_{i=1}^n$ we can approximate any $f(x)$ is one step. For example, in \textcite{jacotNeuralTangentKernel2020} we learn a function that would give us the right kernel.
