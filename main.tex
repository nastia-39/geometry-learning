...
This assumption ensures two things: existence of the efficient coordinate system in the space $\mathcal{X}$ and efficient learning rate for smooth functions. Moreover, this assumption of the underlying learning space is strictly stronger than the manifold hypothesis and unifies multiple learning problems, e.g. classical kernel methods, flow matching/diffusion models and transformers.
